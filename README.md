...
A standalone Three.js Earth renderer focused on a presentation-ready look: layered surface color grading, cloud shell, cloud shadows, night-side compression, black rim, optional blue atmosphere shell, rotation, and live tuning controls.
